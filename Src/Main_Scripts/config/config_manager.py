...
class ConfigPresets:
    ...
    def medium() -> Config:
        ...
        return Config(
            ...
            precision="mixed_fp16",  # Mixed precision for better stability
    ...
    def speed_optimized() -> Config:
        """Configuration optimized specifically for maximum speed."""
        return Config(
    ...
    def production() -> Config:
        """Production-ready configuration with reliability focus."""
        return Config(
    ...
    def experimental() -> Config:
        ...
        return Config(
            ...
            experiment_name="experimental_model",
            log_level="DEBUG",
            gradient_checkpointing=True,
            use_stable_embedding=True,
            init_std=0.018,
    ...
    def get_preset_info() -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "small": {
                ...
                "model_size": "Small (~25M parameters)",
                "memory_usage": "Low",
                "training_speed": "Fast",
            ...
            "medium": {
                ...
                "model_size": "Medium (~100M parameters)",
                "memory_usage": "Medium",
                "training_speed": "Medium",
                "precision": "mixed_fp16/bf16"
            },
            "large": {
                "description": "Large model for high-end training",
                "use_case": "High-performance applications",
                "model_size": "Large (~500M parameters)",
                "memory_usage": "High",
                "training_speed": "Slow",
            ...
            "inference_optimized": {
                ...
                "model_size": "Medium (~80M parameters)",
                "memory_usage": "Medium",
                "training_speed": "Fast",
            ...
            "quality_focused": {
                ...
                "model_size": "Large (~300M parameters)",
                "memory_usage": "High",
                "training_speed": "Slow",
            ...
            "speed_optimized": {
                ...
                "model_size": "Medium (~50M parameters)",
                "memory_usage": "Medium",
                "training_speed": "Very Fast",
            ...
            "memory_optimized": {
                ...
                "model_size": "Small (~20M parameters)",
                "memory_usage": "Very Low",
                "training_speed": "Medium",
            ...
            "experimental": {
                ...
                "model_size": "Large (~200M parameters)",
                "memory_usage": "High",
                "training_speed": "Medium",
